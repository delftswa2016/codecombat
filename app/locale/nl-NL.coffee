module.exports = nativeDescription: "Nederlands (Nederland)", englishDescription: "Dutch (Netherlands)", translation:
  ...
  new_home:
    ...
    teaching_computer_science: "Je hebt geen diploma infomatica nodig om te kunnen programmeren, wij verschaffen de materialen waarmee elke docent programmeerles kan geven."
